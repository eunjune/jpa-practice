...
import com.example.jpapractice.domain.Item.Book;
...
import com.example.jpapractice.exception.NotEnoughStockException;
...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("주문한 상품 종률 수가 정확해야 한다.", 1, getOrder.getOrderItems().size());
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문이 취소된 사품은 그만큼 재고가 증가해야 한다.",10, item.getStockQuantity());
    }
